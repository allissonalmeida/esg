...
<div class="row">
	...
	<div class="col-md-11">
		...
		</a>Plataforma Reciclagem</b> ESG
		</h1>

	</div>

	<div class="col-md-1">
		<a href="index.php?pag=pla_reciclagem">
...
<center>
    ...
    <a href="index.php?pag=pla_reciclagem">
        <img class="" src="../img/pla_reciclagem.pngg" alt="" width="10%">
    </a>
...
<div class="row">
	<div class="col-md-11">
<canvas id="myChart" width="10%" height="2%"></canvas>
	</div>
</div>
