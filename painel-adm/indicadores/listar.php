...
$query = $pdo->prepare("SELECT a.*, b.nome as nome_plataforma, b.id as id_plataforma FROM indicadores a LEFT JOIN plataformas b ON (b.id = a.id_plataforma) ORDER BY b.nome ASC");
